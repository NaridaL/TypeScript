//// [identifierBracesUnicodeEscapeSequence.ts]
const n = 1;
...
//// [identifierBracesUnicodeEscapeSequence.js]
var n = 1;
var \u{6E}\u{303} = "n\u0303"; // Latin lowercase "n" followed by the combining tilde "◌̃") is defined by Unicode to be canonically equivalent to the single code point U+00F1
var \u{f1} = "\u00F1"; // unicode string canonically equivalent to the above, but a distinct identifier.
var \u{0000006d} = "l"; // lowercase d and unnecessary padding 0s
// usage as object
\u{f1}.toUpperCase();
foo(\u{6E}\u{303});
// mixed with normal characters:
